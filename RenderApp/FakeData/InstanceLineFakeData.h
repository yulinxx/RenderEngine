...
public:
     ...
     * @return 实例化线段数据数组
     */
    std::vector<GLRhi::InstanceLineData>& getInstanceData();
...
private:
     ...
     * @return 实例化线段数据
     */
    GLRhi::InstanceLineData genSingleLine(float minWidth, float maxWidth);

private:
    std::vector<GLRhi::InstanceLineData> m_instanceData; // 实例化线段数据
};

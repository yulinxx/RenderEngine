...
public:
     ...
     * @return 实例化三角形数据数组
     */
    const std::vector<GLRhi::InstanceTriangleData>& getInstanceData() const;
...
private:
     ...
     * @return 实例化三角形数据
     */
    GLRhi::InstanceTriangleData genSingleTriangle(float minSize, float maxSize);

private:
    std::vector<GLRhi::InstanceTriangleData> m_instanceData; // 实例化三角形数据
};
